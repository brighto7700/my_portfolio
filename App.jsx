...
function App() {
  ...
  // Typewriter effect & SEO JSON-LD Injection
  useEffect(() => {
    // 1. Typewriter Effect
    let i = 0;
    ...
    // 2. Inject JSON-LD for Google SEO
    const structuredData = {
      "@context": "https://schema.org",
      "@type": "Person",
      "name": "Bright Emmanuel",
      "alternateName": "Brighto G",
      "url": "https://your-portfolio-domain.com", // Replace with your actual domain when deployed
      "image": "https://your-portfolio-domain.com/og-main.png",
      ...
      "sameAs": [
        ...
        "https://linkedin.com/in/yourusername" // Update this
      ]
    };
